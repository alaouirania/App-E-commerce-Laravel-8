                    ...
                    <tbody>
                        @foreach ($data as $key => $permission)
                            <tr>
                                ...
                                <td>
                                    <a class="btnshow btn-success" href="{{ route('permissions.show',$permission->id) }}">Show</a>
                                    @can('role-edit')
                                        <a class="btnedit btn-primary" href="{{ route('permissions.edit',$permission->id) }}">Edit</a>
                                    @endcan
                                    @can('role-delete')
